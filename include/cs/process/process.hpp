#ifndef CS_PROCESS_HPP
#define CS_PROCESS_HPP
...
#include <cs/process/details/process_exception.hpp>

namespace cs {
using ProcessException = details::ProcessException;
